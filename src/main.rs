...
fn handle_events(window: &mut glfw::Window, events: &Receiver<(f64, glfw::WindowEvent)>, camera: &mut Camera, chunk: &[[[Block; 16]; 16]; 16], vertices: &mut Vec<Vertex>, mesh: &mut Mesh) {
